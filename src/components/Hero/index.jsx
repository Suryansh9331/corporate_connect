...
// import heroDesktop from '../../assets/home_heroImage.svg'; 
// import heroMobile from '../../assets/mobile_home_hero.svg'; 
// import heroTablet from '../../assets/hero_home_for_tab.svg'; 
...
//       <div className="hidden lg:block relative w-full min-h-[50vh] overflow-hidden pl-48 pt-12">
//         {/* Background Image */}
//         <img
//           src={heroDesktop}
//           alt="Desktop Hero"
//           className="max-w-[1200px]  h-auto object-cover "
//         />

//         {/* Overlay Text */}
//         <div className="absolute top-1/3 left-48 transform -translate-y-1/2 text-left">
//           <h1 className="text-6xl font-light text-gray-900 leading-snug">
//             Hire the people <br /> you need
//           </h1>
//           <button className="mt-6 bg-[#0073b1] text-white font-semibold px-6 py-2 rounded hover:bg-[#485d69] transition">
//             Contact us
//           </button>
//         </div>
//       </div>
