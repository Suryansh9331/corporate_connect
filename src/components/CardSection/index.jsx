...
//         <h1 className="text-center text-2xl md:text-3xl text-gray-800 font-light mb-16 lg:mt-10">
...
//               features: [
//                 "Limited LinkedIn network access",
...
//               features: [
//                 "Unlimited LinkedIn network access",
...
//             >
//               {/* Header */}
//               <div className={`${card.bg} p-6 flex flex-col items-center`}>
//                 <h2 className="text-3xl font-bold text-[#4b4843] text-center">
//                   {card.title}
//                 </h2>
//                 <p className="text-lg mt-4 text-[#4b4843] mb-4 text-center">
//                   {card.subtitle}
//                 </p>
//                 <img
//                   src={card.img}
...
//                 <div>
//                   <h3 className="font-medium text-[#4c4c4c] mb-2 text-xl">
//                     Who it's best for
//                   </h3>
//                   <p className="text-md text-gray-700 mb-8">{card.who}</p>

//                   <h3 className="font-medium text-[#4c4c4c] mb-2 text-xl">
//                     Key features
//                   </h3>
//                   <ul className="mb-6 list-disc list-inside text-md text-gray-700 space-y-1">
...
//                       className="py-2 px-6 border border-[#0077b5] text-[#0077b5] font-medium hover:bg-[#0077b5] hover:text-white transition-colors text-sm text-center"
//                     >
//                       {card.button.text}
//                     </a>
//                   </div>
...
//           <a
//             href="#"
//             className="px-6 py-2 bg-[#0077b5] text-white font-medium rounded-full hover:bg-[#005b8a] transition-colors text-base"
//           >
//             Compare products
//           </a>
//         </div>
